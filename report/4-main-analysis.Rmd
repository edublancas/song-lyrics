...
4. `profiles.json` - Summary for artists with at least 10 songs, this is the dataset used in the interactive component
5. `artists.json` - List of artists with at least 10 songs, this is also used in the interactive component
...
### How do topics differ across the world?
...
### Topic Related Hypothoses and Next Steps
