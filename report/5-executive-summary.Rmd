...
The sentiment dataset from the TidyText package was used to obtain the sentiment for the words in our final data set. By using the AFFIN, bing and nrc lexicons we explored the following topics:
...
```{r nrcGenreYearExec,fig.height=12,fig.width=12}
