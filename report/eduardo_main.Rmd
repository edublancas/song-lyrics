...
Here we see two interesting things: Céline Dion looks brigther, meaning that her lyrics are different from the rest of the artists. If we look at the upper corner, we see a group of artists with low distances: Will Young (England), Wet Wet Wet (Scotland) and Westlife (Ireland).
...
plot_matrix(kooks, 'The Kooks (30 sample songs)',
            groups=2, only_lower_half=TRUE)
```
